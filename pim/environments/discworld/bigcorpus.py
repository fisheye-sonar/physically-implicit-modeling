...
# dw-16ray (2026-09-14, Sevan): dw-8ray with 18 rays CAST, wall rays dropped -> 16 kept; radius 1.0
# (the ray-count axis upward: 5 -> 8 -> 16 kept rays, same radius; 128 rays = dw-noiseless at radius 0.5)
_RAYS_16 = ["--obs-res", "18", "--drop-edge-rays", "--radius", "1.0", "--max-edit-attempts", "2000"]
_RAYS16_RANGES = [(270_000_000_000, 290_000_000_000, "dw-16ray train"),
...
# dw-128ray (2026-09-15 night, Sevan): the ray-count axis closed at the top — dw-8ray geometry
# (radius 1.0, wall rays dropped, max-edit-attempts 2000) with 130 rays CAST -> 128 kept. This is
# NOT dw-noiseless (radius 0.5, 128 cast, no drop): it separates the ray count from the disc size
# that the 5/8/16-ray family and dw-noiseless had confounded.
_RAYS_128R = ["--obs-res", "130", "--drop-edge-rays", "--radius", "1.0", "--max-edit-attempts", "2000"]
_RAYS128_RANGES = [(300_000_000_000, 320_000_000_000, "dw-128ray train"),
                   (325_000_000_000, 325_400_000_000, "dw-128ray eval suite"),
                   (1_100_000_000_000, 1_101_000_000_000, "dw-128ray probe suite"),
                   (1_110_000_000_000, 1_111_000_000_000, "dw-128ray probe_large")]
...
_SMOOTH_RANGES = _SMOOTH_RANGES + _OBS5_RANGES + _RAYS16_RANGES + _RAYS128_RANGES     # every list that forbids dw-smooth forbids obs5, 16ray and 128ray too
...
INSTANCES = {
    ...
    "dw-smooth": {  # dw-noiseless + the smooth power-dome disc profile (anti-aliasing instance)
        ...
        "forbidden": [(0, 120_000, "dset4-era eval"), (3_000_000, 3_950_000, "dset17"),
                      ...
                      (1_030_000_000_000, 1_031_000_000_000, "dw-5ray probe_large"),
                      (1_040_000_000_000, 1_041_000_000_000, "dw-smooth probe suite"),
                      (1_050_000_000_000, 1_051_000_000_000, "dw-smooth probe_large")] + _OBS5_RANGES + _RAYS16_RANGES + _RAYS128_RANGES,
    },
    "dw-8ray-obs5": {  # dw-8ray + five observers on the ring, circular arena (observers.py)
        ...
        "forbidden": [(0, 120_000, "dset4-era eval"), (3_000_000, 3_950_000, "dset17"),
                      ...
                      (1_050_000_000_000, 1_051_000_000_000, "dw-smooth probe_large"),
                      (1_060_000_000_000, 1_061_000_000_000, "dw-8ray-obs5 probe suite"),
                      (1_070_000_000_000, 1_071_000_000_000, "dw-8ray-obs5 probe_large")] + _RAYS16_RANGES + _RAYS128_RANGES,
    },
    "dw-16ray": {  # dw-8ray with 16 usable rays (18 cast, wall rays dropped); radius 1.0 — the ray axis upward
        "base_seed": 270_000_000_000,
        "obs_dim": 16,
        "sim_flags": _COMMON_FLAGS + _RAYS_16 + ["--position-noise", "0.0", "--obs-noise-std", "0.0"],
        "forbidden": [(0, 120_000, "dset4-era eval"), (3_000_000, 3_950_000, "dset17"),
                      (10_000_000, 19_800_000_000, "dw-pn04 train"),
                      (30_000_000_000, 50_000_000_000, "dw-noiseless train"),
                      (52_000_000_000, 52_400_000_000, "dw-noiseless eval suite"),
                      ...
                      (1_070_000_000_000, 1_071_000_000_000, "dw-8ray-obs5 probe_large"),
                      (1_080_000_000_000, 1_081_000_000_000, "dw-16ray probe suite"),
                      (1_090_000_000_000, 1_091_000_000_000, "dw-16ray probe_large")] + _RAYS128_RANGES,
    },
    "dw-128ray": {  # dw-8ray with 128 usable rays (130 cast, wall rays dropped); radius 1.0 — the ray axis closed at the top
        "base_seed": 300_000_000_000,
        "obs_dim": 128,
        "sim_flags": _COMMON_FLAGS + _RAYS_128R + ["--position-noise", "0.0", "--obs-noise-std", "0.0"],
        "forbidden": [(0, 120_000, "dset4-era eval"), (3_000_000, 3_950_000, "dset17"),
                      (10_000_000, 19_800_000_000, "dw-pn04 train"),
                      (30_000_000_000, 50_000_000_000, "dw-noiseless train"),
                      (52_000_000_000, 52_400_000_000, "dw-noiseless eval suite"),
