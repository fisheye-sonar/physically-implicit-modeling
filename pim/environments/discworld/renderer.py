...
def render_frame(
    ...
    from pim.environments.discworld.render2d import omni2d_enabled, render_frame_omni2d
    from pim.environments.discworld.soft_render import render_frame_soft, soft_enabled
