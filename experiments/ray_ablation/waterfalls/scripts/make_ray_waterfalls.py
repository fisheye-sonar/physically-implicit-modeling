...
`pim.environments.discworld` — nothing canonical is touched.
    ...
    PYTHONPATH=. .pim/bin/python experiments/ray_ablation/waterfalls/scripts/make_ray_waterfalls.py
    # bigger, faster discs (radius 1.0, speed 0.08-0.20) -> *_big.gif
    PYTHONPATH=. .pim/bin/python experiments/ray_ablation/waterfalls/scripts/make_ray_waterfalls.py --big
