...
Outputs (experiments/othello_by_step/decode/): scores/decode_by_step_<run>.json and
...
def main() -> None:
    ...
    model.eval()
    exp = REPO / "experiments" / "othello_by_step" / "decode"
    ...
    from pim.environments.othello.data import flatten_rows
