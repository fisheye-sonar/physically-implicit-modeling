...
| `ray_ablation/L-dw-5ray-20m` | Transformer-L (regression) | dw-5ray | 780k steps, matched recipe — the quantisation push (launched 2026-09-10 night, unit `dw_5ray`, `scripts/drivers/dw_5ray.sh`; `Linear(5, 512)` in/out). Scored canonically + `appearance-fac` (stage E). Prediction on record (Sevan): editability rises further than dw-8ray's (PI +0.41 / ND +0.50 / GS +0.46 under `appearance-fac`). *Result pending.* |
