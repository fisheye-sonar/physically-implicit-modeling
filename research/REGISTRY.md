...
| `smooth_ablation/L-dw-smooth-20m` | Transformer-L (regression) | dw-smooth | 780k steps, matched recipe — the anti-aliasing instance (stage 7 of the 2026-09-12 overnight chain, unit `rescore_protocol`, `scripts/drivers/rescore_2026-09-12.sh`). **In flight 2026-09-12 night**: scored canonically (frustum) + `appearance-fac` (probes + both floors, stage 8) when the chain completes (~2026-09-13 evening); listed in `build_full_tables` (long list) from birth. |
