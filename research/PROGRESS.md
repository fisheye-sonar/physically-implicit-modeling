...
**Dropout 0.7 in flight (2026-09-13 19:41 →):** `dropout_ablation/L-oth-adjacent-drop07-390k` (Sevan's ask), unit `oth_adjacent_drop07` on wsl-sevan, driver `experiments/dropout_ablation/drivers/oth_adjacent_drop07.sh`; ETA training ≈ 08:45 PDT 09-14, remote-scored ≈ 09:30 → pull, rescore at 2026-09-12.1 on the lab box, INLP, five-way compare. ⚠ Remote clone is still at 17c00e8 (old eval version, old notebook names): every remote-scored run must be rescored here before it enters a table.
